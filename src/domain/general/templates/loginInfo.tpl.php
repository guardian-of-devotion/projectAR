...
<div class="userinfo">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="nav-header border"><?=$this->__("label.administration")?></li>
            ...
            <li <?php if($module == 'markers') echo" class='active' "; ?>>
                <a href='<?=BASE_URL ?>/markers/showAll/'>
                    <?=$this->__("menu.markers")?>
                </a>
            </li>
            <li <?php if($module == 'projectroles') echo" class='active' "; ?>>
                <a href='<?=BASE_URL ?>/projectroles/showAll/'>
                    <?=$this->__("menu.projectroles")?>
                </a>
            </li>

            <li <?php if($module == 'checkLists') echo" class='active' "; ?>>
                <a href='<?=BASE_URL ?>/checkLists/showAll/'>
                    <?=$this->__("menu.check_lists")?>
                </a>
            </li>
