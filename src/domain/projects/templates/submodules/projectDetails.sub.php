...
<form action="" method="post" class="stdform">
    ...
    <div class="row-fluid">
        ...
        <div class="span8">
            <div class="row-fluid">
                <div class="span12">
                    <h4 class="widgettitle title-light"><span class="iconfa iconfa-leaf"></span><?=$this->__('label.checkList'); ?></h4>

                    <div class="form-group">

                        <label  class="span4 control-label" for="checkList"><?=$this->language->__('label.checkList'); ?></label>
                        <div class="span6">
