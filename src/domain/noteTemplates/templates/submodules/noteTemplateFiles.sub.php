                ...
                <div class="inlineDropDownContainer" style="float:right;">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php  if ($login::userIsAtLeast("clientManager")) { ?>
                            <li><a href="<?=BASE_URL ?>/noteTemplates/editNoteTemplate/<?php echo $noteTemplate->id ?>?delFile=<?php echo $file['id'] ?>" class="delete"><i class="fa fa-trash"></i> <?php echo $this->__("links.delete"); ?></a></li>
                        <?php  } ?>
