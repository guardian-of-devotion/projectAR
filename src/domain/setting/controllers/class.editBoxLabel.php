...
namespace leantime\domain\controllers {
    ...
    class editBoxLabel
    {
        ...
        public function __construct()
        {
            ...
            $this->noteRepo = new repositories\notes();
        ...
        public function get($params)
        {
            ...
            if(core\login::userIsAtLeast("clientManager")) {
                ...
                if (isset($params['module']) && isset($params['label'])) {
                    ...
                    if ($params['module'] == "notelabels") {
                        $stateLabels = $this->noteRepo->getStateLabels();
                        $currentLabel = $stateLabels[$params['label']]["name"];
                    }
        ...
        public function post($params)
        {
            ...
            if (isset($_GET['module']) && isset($_GET['label'])) {
                ...
                if ($_GET['module'] == "notelabels") {

                    $currentStateLabels = $this->noteRepo->getStateLabels();
                    $newStateLabels = array();
                    foreach ($currentStateLabels as $key => $label) {
                        $newStateLabels[$key] = $label["name"];
                    }
                    ...
                    unset($_SESSION["projectsettings"]["notelabels"]);
                    $this->settingsRepo->saveSetting("projectsettings." . $_SESSION['currentProject'] . ".notelabels",
                        serialize($newStateLabels));
                }
