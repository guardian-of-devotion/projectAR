...
namespace leantime\domain\controllers {
    ...
    class showKanban
    {
        ...
        public function get(array $params) {
            ...
            $this->tpl->assign('allNoteStates', $this->noteService->getStatuses());
            $this->tpl->assign('allNotes', $this->noteService->getAllNotesForProjects());
        ...
        public function post(array $params) {
            ...
            if(isset($_POST['quickaddNote']) == true) {

                $result = $this->noteService->quickAddNote($params);
