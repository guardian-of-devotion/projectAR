<?php
    ...
    //All states >0 (<1 is archive) ticket + note
    $numberofColumns = (count($this->get('allTicketStates')) - 1) + 1;
...
<div class="maincontent">
	...
	<div class="maincontentinner">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="<?= BASE_URL ?>/tickets/ticketRoadmap"><i
                                                class="fa fa-edit"></i> <?php echo $this->__("links.ticket_roadmap"); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
			...
			<div class="filterBar <?php if(!isset($_GET['search'])) { echo "hideOnLoad"; } ?>">
				<div class="row-fluid" style="opacity:0.4">
                    ...
                    <div class="filterBoxLeft">
                        ...
                        <label class="inline"><?=$this->__("label.todo_marker") ?></label>
                        <div class="form-group">
                            <select data-placeholder="<?=$this->__("input.placeholders.filter_by_marker") ?>" title="<?=$this->__("input.placeholders.filter_by_marker") ?>" name="markerId" id="markerSelect">
                                <option value=""><?=$this->__("label.all_markers") ?></option>
                                <?php foreach($this->get('markers') as $markerValue){    ?>

                                    <?php echo"<option value='".$markerValue->id."'";

                                    if(isset($searchCriteria['marker']) && ($searchCriteria['marker'] == $markerValue->id)) echo" selected='selected' ";
        ...
        <div class="sortableTicketList" >

            <div class="row-fluid">
                <div id="sortableNoteKanban" class="sortableTicketKanban">
                    <?php
                    foreach ($this->get('allNoteStates') as $key => $statusRow) {
                        ...
                        <div class="column" style="width:<?= $size ?>%; margin-right: 10px;">

                            <h4 class="widgettitle title-primary titleBorderColor<?php echo $key; ?>" style="color: black; background-color: #ffffff">
                                <?php if ($login::userIsAtLeast("clientManager")) { ?>
                                    <a href="<?= BASE_URL ?>/setting/editBoxLabel?module=notelabels&label=<?= $key ?>"
                            ...
                            <div class="contentInner <?php echo "status_" . $key; ?>">
                                <div>
                                    <a href="javascript:void(0);" class="quickAddLink" id="note_new_link_<?= $key ?>"
                                       onclick="jQuery('#note_new_<?= $key ?>').toggle('fast', function() {jQuery(this).find('input[name=headline]').focus();}); jQuery(this).toggle('fast');"><i
                                                class="fas fa-plus-circle"></i> <?php echo $this->__("links.add_note_no_icon"); ?>
                                    </a>
                                    <div class="noteBox hideOnLoad " id="note_new_<?= $key ?>">

                                        <form method="post">
                                            <input type="text" name="headline" style="width:100%;"
                                                   title="<?= $this->__("label.headline") ?>"/><br/>
                                            <input type="hidden" name="status" value="<?php echo $key; ?> "/>
                                            <input type="submit" value="Save" name="quickaddNote"/>
                                            <a href="javascript:void(0);"
                                               onclick="jQuery('#note_new_<?= $key ?>').toggle('fast'); jQuery('#note_new_link_<?= $key ?>').toggle('fast');">
                                ...
                                <?php foreach ($this->get('allNotes') as $row) { ?>
                                    <?php if ($row["status"] == $key) { ?>
                                        <div class="ticketBox moveable container" id="note_<?php echo $row["id"]; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                        <div class="inlineDropDownContainer" style="float:right;">
                                                            ...
                                                            <a href="javascript:void(0);"
                                                               class="dropdown-toggle noteDropDown"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <a href="<?= BASE_URL ?>/notes/showNote/<?php echo $row["id"]; ?>"><i
                                                                                class="fa fa-edit"></i> <?php echo $this->__("links.note_edit"); ?>
                                                                    </a></li>
                                                                <li>
                                                                    <a href="<?= BASE_URL ?>/notes/delNote/<?php echo $row["id"]; ?>"
                                                                       class="delete"><i
                                                                                class="fa fa-trash"></i> <?php echo $this->__("links.note_delete"); ?>
                                                                    </a></li>
                                                            </ul>
                                                        </div>
                                                    <small><i class="fa"></i> <?php echo $this->__("label.note"); ?>
                                                    </small>

                                                    <h4>
                                                        <a href="<?= BASE_URL ?>/notes/showNote/<?php echo $row["id"]; ?>"><?php $this->e($row["headline"]); ?></a>
                                                    </h4>
                ...
                <div id="sortableTicketKanban" class="sortableTicketKanban ps-10">
                    ...
                    foreach ($this->get('allTicketStates') as $key => $statusRow) {
                        ...
                        <div class="column" style="width:<?= $size ?>%;">
                            ...
                            <div class="contentInner <?php echo "status_" . $key; ?>">
                                <div>
                                    <a href="javascript:void(0);" class="quickAddLink" id="ticket_new_link_<?= $key ?>"
                                       onclick="jQuery('#ticket_new_<?= $key ?>').toggle('fast', function() {jQuery(this).find('input[name=headline]').focus();}); jQuery(this).toggle('fast');"><i
                                                class="fas fa-plus-circle"></i> <?php echo $this->__("links.add_todo_no_icon"); ?>
                                    </a>
                                    <div class="ticketBox hideOnLoad " id="ticket_new_<?= $key ?>">
                                        ...
                                        <form method="post">
                                            ...
                                            <input type="hidden" name="milestone"
                                                   value="<?php echo $searchCriteria['milestone']; ?>"/>
                                            <input type="hidden" name="status" value="<?php echo $key; ?> "/>
                                            <input type="hidden" name="sprint"
                                                   value="<?php echo $_SESSION["currentSprint"]; ?> "/>
                                            <input type="submit" value="Save" name="quickadd"/>
                                            <a href="javascript:void(0);"
                                               onclick="jQuery('#ticket_new_<?= $key ?>').toggle('fast'); jQuery('#ticket_new_link_<?= $key ?>').toggle('fast');">
                                                <?= $this->__("links.cancel") ?>
                                            </a>
                                        </form>
                                        ...
                                        <div class="ticketBox moveable container" id="ticket_<?php echo $row["id"]; ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    if ($login::userIsAtLeast("developer")) {
                                                        ...
                                                        <div class="inlineDropDownContainer" style="float:right;">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li class="nav-header"><?php echo $this->__("subtitles.todo"); ?></li>
                                                                <li>
                                                                    <a href="<?= BASE_URL ?>/tickets/showTicket/<?php echo $row["id"]; ?>"><i
                                                                                class="fa fa-edit"></i> <?php echo $this->__("links.edit_todo"); ?>
                                                                    </a></li>
                                                                <li>
                                                                    <a href="<?= BASE_URL ?>/tickets/delTicket/<?php echo $row["id"]; ?>"
                                                                       class="delete"><i
                                                                                class="fa fa-trash"></i> <?php echo $this->__("links.delete_todo"); ?>
                                                                    </a></li>
                                                                <li class="nav-header border"><?php echo $this->__("subtitles.track_time"); ?></li>
                                                                <li id="timerContainer-<?php echo $row['id']; ?>"
                                                                    class="timerContainer">
                                                                    <a class="punchIn" href="javascript:void(0);"
                                                                       data-value="<?php echo $row["id"]; ?>" <?php if ($clockedIn !== false) {
                                                                        echo "style='display:none;'";
                                                                    } ?>><span class="iconfa-time"></span> <?php echo $this->__("links.start_work"); ?>
                                                                    </a>
                                                                    <a class="punchOut" href="javascript:void(0);"
                                                                       data-value="<?php echo $row["id"]; ?>" <?php if ($clockedIn === false || $clockedIn["id"] != $row["id"]) {
                                                                        echo "style='display:none;'";
                                                                    } ?>><span class="iconfa-stop"></span> <?php if (is_array($clockedIn) == true) {
                                                    ...
                                                    <?php } ?>
                                                    <small><i class="fa <?php echo $todoTypeIcons[strtolower($row['type'])]; ?>"></i> <?php echo $this->__("label." . strtolower($row['type'])); ?>
                                                    </small>

                                                    <h4>
                                                        <a href="<?= BASE_URL ?>/tickets/showTicket/<?php echo $row["id"]; ?>"><?php $this->e($row["headline"]); ?></a>
                                                    </h4>
                                                    <!-- <p class="description"><?php echo $this->truncate(html_entity_decode($row["description"]), 200, '...', false, true); ?><?php if (strlen($row["description"]) >= 200) echo " (...)"; ?></p> -->
                                            ...
                                            */ ?>
                                            ...
                                            <div class="timerContainer" id="timerContainer-<?php echo $row["id"]; ?>">
                                                ...
                                                <div class="dropdown ticketDropdown milestoneDropdown colorized show firstDropdown">
                                                    <a style="background-color:<?= $this->escape($row['milestoneColor']) ?>"
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        aria-labelledby="milestoneDropdownMenuLink<?= $row['id'] ?>">
                                                        <li class="nav-header border"><?= $this->__("dropdown.choose_milestone") ?></li>
                                                        <li class='dropdown-item'><a style='background-color:#1b75bb'
                                                                                     href='javascript:void(0);'
                                                                                     data-label="<?= $this->__("label.no_milestone") ?>"
                                                                                     data-value='<?= $row['id'] . "_0_#1b75bb" ?>'> <?= $this->__("label.no_milestone") ?> </a>
                                                        </li>
                                                ...
                                                <div class="dropdown ticketDropdown effortDropdown show">
                                                    <a class="dropdown-toggle f-left  label-default effort"
                                                       href="javascript:void(0);" role="button"
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        aria-labelledby="effortDropdownMenuLink<?= $row['id'] ?>">
                                                ...
                                                <div class="dropdown ticketDropdown priorityDropdown show">
                                                    <a class="dropdown-toggle f-left  label-default priority"
                                                       href="javascript:void(0);" role="button"
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        aria-labelledby="priorityDropdownMenuLink<?= $row['id'] ?>">
                                                ...
                                                <div class="dropdown ticketDropdown markerDropdown show">
                                                    <a class="dropdown-toggle f-left label-default marker"
                                                       href="javascript:void(0);" role="button"
                                                       id="markerDropdownMenuLink<?= $row['id'] ?>"
                                                       data-toggle="dropdown" aria-haspopup="true"
                                                       aria-expanded="false">
                                                                <span class="text"><?php
                                                                    if ($row['markerId'] != '' && $row['markerId'] > 0) {
                                                                        echo $row['markerName'];
                                                                    } else {
                                                                        echo $this->__("label.marker_unkown");
                                                                    } ?>
                                                                </span>
                                                        &nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i>
                                                    </a>
                                                    <ul class="dropdown-menu"
                                                        aria-labelledby="markerDropdownMenuLink<?= $row['id'] ?>">
                                                        <li class="nav-header border"><?= $this->__("dropdown.select_marker") ?></li>
                                                        <?php foreach ($markers as $markerValue) {
                                                            echo "<li class='dropdown-item'>
                                                                            <a href='javascript:void(0);' data-value='" . $row['id'] . "_" . $markerValue->id . "_" . $markerValue->name . "' id='ticketMarkerChange" . $row['id'] . $markerValue->id . "'>" . $markerValue->name . "</a>";
                                                            echo "</li>";
                                                        } ?>
                                                    </ul>
                                                </div>
