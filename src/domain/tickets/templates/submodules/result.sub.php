...
<div class="row-fluid">
    <div class="span7">
        <h4 class="widgettitle title-light"><span
                    class="iconfa iconfa-asterisk"></span><?php echo $this->__('label.result'); ?>
        </h4>
        <textarea  name="result"  <?php if ($ticket->status < 1) {echo ' readonly ';} ?> rows="10" cols="80"
                  class="tinymce"><?php echo $ticket->result ?></textarea><br/>
        <input type="submit" <?php if ($ticket->status < 1) {echo 'disabled' . ' hidden';} ?>  name="saveTicketResult" value="<?php echo $this->__('buttons.save'); ?>"/>
    </div>
</div>
<div class="row-fluid">
    <div class="span7">
        <div class="mediamgr_category">
                ...
                <div class="par f-left" style="margin-right: 15px;">
                    ...
                    <input type='file' name='file'/>
                            ...
                            <a href='#' class='btn fileupload-exists'
                               data-dismiss='fileupload'><?php echo $this->__("buttons.remove"); ?></a>
                        </div>
                    </div>
                </div>

                <input type="submit" <?php if ($ticket->status < 1) {echo 'disabled' . ' hidden';} ?> name="uploadResultFile" class="button"
            ...
            <div class="mediamgr_content">
                ...
                <ul id='medialist' class='listfile'>
                    <?php foreach ($this->get('ticketResultFiles') as $file): ?>
                            ...
                            <div class="inlineDropDownContainer" style="float:right;">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php if ($login::userIsAtLeast("developer")) { ?>
                                        <li>
                                            <a href="<?= BASE_URL ?>/tickets/showTicket/<?php echo $ticket->id ?>?delFile=<?php echo $file['id'] ?>"
                                               class="delete"><i
                                                        class="fa fa-trash"></i> <?php echo $this->__("links.delete"); ?>
                                            </a></li>
                                    <?php } ?>
