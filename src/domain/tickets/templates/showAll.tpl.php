                    ...
                    <div class="pull-right">
                        ...
                        <div class="btn-group viewDropDown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="<?= BASE_URL ?>/tickets/ticketRoadmap"><i class="fa fa-edit"></i> <?php echo $this->__("links.ticket_roadmap"); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="form-group">
                            <select data-placeholder="<?=$this->__("input.placeholders.filter_by_marker") ?>" title="<?=$this->__("input.placeholders.filter_by_marker") ?>" name="markerId" id="markerSelect">
                                ...
                                <?php foreach($this->get('markers') as $markerValue){    ?>
                                    ...
                                    if(isset($searchCriteria['markerId']) && ($searchCriteria['markerId'] == $markerValue->id)) echo" selected='selected' ";
            ...
            <tbody>
                <?php foreach($this->get('allTickets') as $row){?>
                    <tr>
                        ...
                        <td data-order="<?=$row['markerId'] ? $markers[$row['markerId']] : $this->__("label.marker_unkown"); ?>">
                            <div class="dropdown ticketDropdown markerDropdown show">
                                <a class="dropdown-toggle f-left  label-default marker" href="javascript:void(0);" role="button" id="markerDropdownMenuLink<?=$row['id']?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <span class="text"><?php
                                ...
                                <ul class="dropdown-menu" aria-labelledby="markerDropdownMenuLink<?=$row['id']?>">
