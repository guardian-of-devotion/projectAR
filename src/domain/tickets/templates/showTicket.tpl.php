    ...
    <div class="maincontentinner">
        ...
        <div class="tabbedwidget tab-primary ticketTabs" style="visibility:hidden;">
            ...
            <ul>
                ...
                <li><a href="#artefact"><?php echo $this->__("tabs.tickets_artefact") ?> (<?php echo $this->get('numRelatedTickets');?>)</a></li>
            ...
            <div id="result">
                <form method="post" action="#result" class="ticketModal" enctype="multipart/form-data">
                    <?php $this->displaySubmodule('tickets-result') ?>
                </form>
            </div>

            <div id="artefact">
                <form method="post" action="#result" class="ticketModal" enctype="multipart/form-data">
                    <?php $this->displaySubmodule('tickets-artefact') ?>
                </form>
            </div>
        </div>
