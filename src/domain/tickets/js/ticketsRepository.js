...
leantime.ticketsRepository = (function () {
    ...
    var updateTicketDates = function (id, dateStart, dateEnd) {
        ...
        jQuery.ajax(
            {
                ...
                data:
                    {
                        id : id,
                        editFrom: dateStart.format("YYYY-MM-DD"),
                        editTo: dateEnd.format("YYYY-MM-DD")
                    }
            }
        ).done(
            function () {
    ...
    return {
        ...
        updateTicketDates:updateTicketDates
    };
})();
