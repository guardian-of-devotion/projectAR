            ...
            <div class="inlineDropDownContainer" style="float:right;">
                ...
                <ul class="dropdown-menu">
                    ...
                    <?php  if ($login::userIsAtLeast("developer")) { ?>
                        <li><a href="<?=BASE_URL ?>/ticketTemplates/editTicketTemplate/<?php echo $ticketTemplate->id ?>?delFile=<?php echo $file['id'] ?>" class="delete"><i class="fa fa-trash"></i> <?php echo $this->__("links.delete"); ?></a></li>
                    <?php  } ?>
