...
namespace leantime\domain\repositories {
    ...
    class users
    {
        ...
        public function getEmployees()
        {
		    ...
		    FROM zp_user 
            LEFT JOIN zp_roles ON zp_user.role = zp_roles.id 
            WHERE zp_roles.roleName IN('developer','admin','manager') 
            ORDER BY lastname";
        ...
        /**
         * getByProjectrole - get all user by projectrole
         *
         * @access public
         * @return array
         */
        public function getByProjectrole($projectrole)
        {
            ...
            foreach ($users as $key => $value) {
                $projectroles = json_decode($value['projectroleId']);
                if (in_array($projectrole, $projectroles)) {
                    $usersByProjectrole[] = $value;
                }
            }

            return $usersByProjectrole;
        }
        ...
        public function editUser(array $values, $id)
        {
            ...
            $stmn->bindValue(':projectroleId', json_encode($values['projectroleId']), PDO::PARAM_STR);
            $stmn->bindValue(':id', $id, PDO::PARAM_STR);
