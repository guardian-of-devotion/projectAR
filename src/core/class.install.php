        ...
        private function sqlPrep()
        {
            $sql =  <<<SQL
                ...
                CREATE TABLE `zp_file` (
                  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
                  `module` enum('project','ticket', 'note','client','user','lead','export','private', 'noteTemplate', 'ticketTemplate', 'ticketResult') DEFAULT NULL,
                  `moduleId` int(11) DEFAULT NULL,
                  `userId` int(11) DEFAULT NULL,
                ...
                INSERT INTO `zp_submodulerights` (alias, title, module, submodule, roleIds) VALUES ('notes-noteDetails','NOTE_DETAILS','notes','noteDetails.sub.php','2,4,5,3');
                INSERT INTO `zp_submodulerights` (alias, title, module, submodule, roleIds) VALUES ('notes-noteFiles','NOTE_FILES','notes','noteFiles.sub.php','2,4,5,3');
                INSERT INTO `zp_submodulerights` (alias, title, module, submodule, roleIds) VALUES ('tickets-result','TICKET_RESULT','tickets','result.sub.php','2,4,5,3');
                ...
                CREATE TABLE `zp_tickets` (
                  ...
                  `userId` int(11) DEFAULT NULL,
                  `relatedTicketId` int(11) DEFAULT NULL,
                ...
                insert  into `zp_user`(`id`,`username`,`password`,`firstname`,`lastname`,`phone`,`profileId`,`lastlogin`,`projectroleId`,`lastpwd_change`,`status`,`expires`,`role`,`session`,`sessiontime`,`wage`,`hours`,`description`,`clientId`, `notifications`, `createdOn`) 
                values (1,:email,:password,:firstname,:lastname,'','',NULL,NULL,0,'a',NULL,'50','','',0,0,NULL,0,1, NOW());
            ...
            CREATE TABLE `zp_marker` (
                ...
                `relatedMarkerId` int(11) DEFAULT NULL,
                PRIMARY KEY (`id`)
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
            
            CREATE TABLE `zp_projectrole` (
                `id` int(11) NOT NULL AUTO_INCREMENT,
                `name` VARCHAR(45) NULL,
            ...
            CREATE TABLE `zp_question` (
                `id` int(11) NOT NULL AUTO_INCREMENT,
                `checkListId` int(11) NOT NULL,
                `headline` varchar(255) DEFAULT NULL,
                `questionText` text DEFAULT NULL,
                PRIMARY KEY (`id`),
                KEY `checkLists` (`checkListId` ASC)
            )  ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
            
            CREATE TABLE `zp_answer` (
                `id` int(11) NOT NULL AUTO_INCREMENT,
                `questionId` int(11) NOT NULL,
                `answerText` text DEFAULT NULL,
                PRIMARY KEY (`id`),
                KEY `Questions` (`questionId` ASC)
            )  ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
            
            CREATE TABLE `zp_note_template` (
                `id` int(11) NOT NULL AUTO_INCREMENT,
                `answerId` int(11) NOT NULL,
                `headline` varchar(255) DEFAULT NULL,
                `description` text,
                `status` int(2) DEFAULT '8',
                `tags` varchar(255) DEFAULT NULL,
                KEY `Answers` (`answerId` ASC),
                PRIMARY KEY (`id`)
            )  ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
            
            CREATE TABLE `zp_ticket_template` (
                `id` int(11) NOT NULL AUTO_INCREMENT,
                `answerId` int(11) NOT NULL,
                `headline` varchar(255) DEFAULT NULL,
